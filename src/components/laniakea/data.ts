...
export const MILKY_WAY: {
  ...
  name: "Млечный Путь",
  description:
    "Наша Галактика — спиральная галактика с перемычкой, содержащая 100–400 млрд звёзд. Находится в Местной группе, на периферии Местного сверхскопления, на расстоянии ~250 млн св. лет от Великого аттрактора, к которому движется со скоростью ~600 км/с вместе со всей Ланиакеей.",
  distance: "Мы здесь",
};
